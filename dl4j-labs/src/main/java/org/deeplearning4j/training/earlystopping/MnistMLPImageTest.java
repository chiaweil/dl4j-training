package org.deeplearning4j.training.earlystopping;
...
{
    private static Logger log = LoggerFactory.getLogger(org.deeplearning4j.solutions.earlystopping.MnistMLPImageTest.class);
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        */
        File imageToTest = new ClassPathResource("").getFile();
        File modelSave =  new ClassPathResource("").getFile();
